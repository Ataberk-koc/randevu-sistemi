...
import { completeAppointment } from "./actions"; // completeAppointment fonksiyonunu import ediyoruz
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500">Randevuları yönetin ve stok durumunu güncelleyin.</p>
        </div>
        <NewAppointment />
      </div>
